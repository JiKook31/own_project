...
for i in range(len(list_universities)):
    try:
        if list_universities[i] in universities:
            universities[list_universities[i]].append((list_ids[i], id_spec_dict[list_ids[i]],
                                                       list_subjects[i], list_grades[i],
                                                       count_subjects[i]))
        else:
            universities[list_universities[i]] = [(list_ids[i], id_spec_dict[list_ids[i]],
                                                   list_subjects[i], list_grades[i],
                                                   count_subjects[i])]
    except KeyError:
        if list_universities[i] in universities:
...
#         try:
#             f.write('"%s",%s,"%s","%s"\n' %(key, spec_id_dict[key][0], spec_id_dict[key][1], spec_id_dict[key][2]))
#         except IndexError:
